...
const server = z.object({
  ...
  KAFKA_CONSUME_NEW_PRODUCTS_USERNAME: z.string().min(1),
  KAFKA_CONSUME_NEW_PRODUCTS_PASSWORD: z.string().min(1)
});
...
const processEnv = {
  ...
  KAFKA_CONSUME_NEW_PRODUCTS_USERNAME: process.env.KAFKA_CONSUME_NEW_PRODUCTS_USERNAME,
  KAFKA_CONSUME_NEW_PRODUCTS_PASSWORD: process.env.KAFKA_CONSUME_NEW_PRODUCTS_PASSWORD
};
